<section class="hero-section residental-hero-area pt-0 wrapper ">

    <header class="header_section pt-2" style="border-color: rgba(255, 255, 255, 0.1);">

        <nav class="navbar navbar-expand-lg center-nav transparent navbar-light"
            style="border-bottom: 1px solid #f5f5f52e;">
            <div class="container flex-lg-row flex-nowrap align-items-center">
                <div class="navbar-brand w-100">
                    <a href="{{ url('/') }}"><img class="logo" src="{{ asset('/assets/images/ftr-logo.svg') }}"
                            alt="Logo"></a>
                </div>
                    ...
                    <div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
                        <ul class="navbar-nav">
                                    ...
                                    <a onclick="Intercom('show');" style="margin: 0 0 0 0; padding: 0 0 0 0;">
                                        <div class="group">
                                            <div class="col-8 first-column-menu">
                                                <svg class="dropdown-icon-svg" width="51" height="51"
                                                    viewbox="0 0 51 51" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <rect width="51" height="51" rx="10" fill="#61C453"
                                        ...
                                        <div class="group">
                                            <div class="col-8 first-column-menu">
                                                <svg class="dropdown-icon-svg" width="51" height="51"
                                                    viewbox="0 0 51 51" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <rect opacity="0.25" width="51" height="51" rx="10"
                                                        fill="#61C453"></rect>
                                                    <path
                                        ...
                                        <div class="group">
                                            <div class="col-8 first-column-menu">
                                                <svg class="dropdown-icon-svg" width="51" height="51"
                                                    viewbox="0 0 51 51" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <rect width="51" height="51" rx="10" fill="#F4BF4F"
                                                        fill-opacity="0.25"></rect>
                                                    <path
                                                        d="M27.2985 14.4774C26.5492 14.0863 25.5199 14.0804 24.7653 14.4701C21.542 16.1348 18.6211 18.0421 16.0637 20.1553C15.7226 20.4371 15.497 20.8315 15.5008 21.2823C15.5047 21.7316 15.7355 22.1216 16.0754 22.3996C18.6123 24.4739 21.5364 26.3834 24.7011 28.0351C25.4505 28.4262 26.4798 28.4321 27.2344 28.0424C30.4576 26.3777 33.3785 24.4704 35.936 22.3572C36.277 22.0754 36.5027 21.681 36.4988 21.2301C36.495 20.7809 36.2642 20.3908 35.9242 20.1129C33.3874 18.0386 30.4632 16.1291 27.2985 14.4774Z"
                                                        fill="#F4BF4F"></path>
                                        ...
                                        <div class="group">
                                            <div class="col-8 first-column-menu">
                                                <svg class="dropdown-icon-svg" width="51" height="51"
                                                    viewbox="0 0 51 51" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <rect opacity="0.25" width="51" height="51"
                                                        rx="10" fill="#F4BF4F"></rect>
                                                    <path
                                                        d="M28.2447 15.17C27.0167 13.9017 24.9826 13.9017 23.7546 15.1699L17.7565 21.3646C17.412 21.7204 17.1806 22.1701 17.0912 22.6572C16.3628 26.6297 16.309 30.6965 16.9322 34.6869L17.1528 36.0996C17.2225 36.5458 17.6068 36.8748 18.0585 36.8748H22.2497C22.5948 36.8748 22.8747 36.595 22.8747 36.2498V27.4998H29.1247V36.2498C29.1247 36.595 29.4045 36.8748 29.7497 36.8748H33.9408C34.3924 36.8748 34.7768 36.5458 34.8465 36.0996L35.0671 34.6869C35.6902 30.6965 35.6365 26.6297 34.908 22.6572C34.8187 22.1701 34.5872 21.7204 34.2427 21.3646L28.2447 15.17Z"
                                                        fill="#F4BF4F"></path>
                                                </svg>
                            ...
                            <li class="nav-item dropdown d-block d-md-none">
                                ...
                                <li class="nav-item"><a class="dropdown-item" onclick="Intercom('show');">IPv4 Datacenter</a></li>
                                <li class="nav-item"><a class="dropdown-item" onclick="Intercom('show');">IPv4 Residential</a></li>
                                <li class="nav-item"><a class="dropdown-item" onclick="Intercom('show');">IPv6 Datacenter</a></li>
                                <li class="nav-item"><a class="dropdown-item" href="/residential-ipv6">IPv6 Residential</a></li>
                                </ul>
                              </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('residential-ipv6') }}">Pricing</a>
                            </li>
                           ...
                           <!--- <li class="nav-item">
                                <a class="nav-link" href="{{ url('https://help.plainproxies.com/en/') }}">Resources</a>

                            </li> -->
                            @include('widgets.resources')
                        </ul><!-- /.navbar-nav -->
                ...
                <div class="navbar-other w-100 d-flex ms-auto">
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                        <li class="nav-item d-none d-md-block">
                            <a href="{{ url('https://dashboard.plainproxies.com/login') }}" class="btn btn-sm btn-outline-primary">Sign In</a>
                            <a href="{{ url('https://dashboard.plainproxies.com/register') }}" class="btn btn-sm btn-primary">Get Started</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div class="hero-txt-wrap text-center">
                    <h6>
                        <a href="{{ url('/residential-ipv6/trial') }}" style="text-decoration: none; color: #077DF9">
                            <span>NEW</span>
                            Limited offer, get your 7 day free trial today. &nbsp;&nbsp;
                            <i class="fas fa-angle-right"></i>
                        </a>
                    </h6>
                    <h1 class="text-white">The Fastest <span> IPv6 </span> <br>
                        Residential Proxies</h1>
                    <p style="color: rgba(255, 255, 255, 0.751);" class="w-100">
                        The IPv6 Residential Proxy Network is a proxy network that solely contains IPs <br>
                        provided by Internet Service Providers (ISPs). These IP addresses have a dedicated <br>
                        geographical location at country or city level, allowing you to gather public data effectively.
                    </p>
                    <div class="hero_btn">
                        <a href="https://dashboard.plainproxies.com/register">Get Started</a>
                        <a onclick="Intercom('show');">Contact Sales <i class="fas fa-angle-right fa-fw"></i>
                            <!-- <i class="fas fa-angle-right"></i> Font Awesome fontawesome.com --></a>
                    </div>
                    <div class="hero-bottom-wrap">
                        <h4 style="color: rgba(255, 255, 255, 0.751);">Trusted By</h4>
                        <ul>
                            <li>
                                <a href="{{ url('#') }}">
                                    <img src="https://plainproxies.com/assets/images/imperial-management.png"
                                        alt="Grey" class="img-fluid">
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('#') }}">
                                    <img src="https://plainproxies.com/assets/images/proxies-gg.png" alt="Grey"
                                        class="img-fluid">
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('#') }}">
                                    <img src="https://plainproxies.com/assets/images/creative-ecom.png" alt="Grey"
                                        class="img-fluid">
                                </a>
                            </li>
                        </ul>
