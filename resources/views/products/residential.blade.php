@php
$pageTitle = 'RESIDENTIAL PROXIES';
$product_title = 'residential';
$product = 'residential';
$businessDetails = [
'businessDetails' => [
'score' => [
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    ...
                    <div class="title2" data-scroll>
                        ...
                        <h6>Experience the superior performance of our premium residential proxies, boasting a pool of
                            60 million unique IPs. Say goodbye to rate limits and enjoy effortless, unrestricted
                            scraping for your data needs.</h6>
    ...
    justify-content: center;
            " data-cue="zoomIn">
                    <figure class="rounded">
                        <img src="{{ asset("/assets/landing/images/residential.svg") }}" alt="hero-img">
                    </figure>
                </div>
            </div>
        </div>
                ...
                <div class="row mt-5">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="mt-2">
                                    <p class="text-explorer">
                                        ...
                                        selecting locations with our 150+ geolocations.
                                    </p>
                        ...
                        <div class="card-wrapper">
                            <div class="card p-3 mb-2">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-explorer">
                                            Maximize potential with unlimited concurrent connections: Unlock
                                            near-limitless access and superior speed on our robust proxy servers.
                                        </p>
                                        <div class="d-flex justify-content-between align-items-center mt-4">
                                            <!-- Text on the left -->

                                            <div>
                                                <a href="{{ url('#') }}">Learn More <i
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="card p-3 mb-2">
                            ...
                            <div class="mt-2">
                                <h6 class="heading">Backconnect Entry
                                </h6>
                                <div class="mt-2">
                                    <p class="text-explorer">
                                        Utilize a single backconnect proxy for rotating IPs, session control, and secure
                                        web scraping with an exceptional 99.9% success rate.
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center mt-4 ">
                                        <!-- Text on the left -->
