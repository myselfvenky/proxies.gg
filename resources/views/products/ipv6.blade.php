        ...
        <div class="row">
            <div class="col-lg-6 align-self-center">
                ...
                <div class="title2" data-scroll>
                    <h1 data-splitting class="title2_con">Buy Premium <span class="title2_{{ $product }}">IPv6
                        </span>
                        Proxies</h1>
                    <div class="space-10"></div>
                    <h6>Experience unparalleled web scraping capabilities with our premium IPv6 proxies. Designed to
                        excel in navigating IPv6 enabled websites, our service grants you access to over 1200+ octillion
                        IPs worldwide. Our offering stands out with exceptional subnet diversity, featuring 16x /32
                        subnets. This ensures robust and efficient web scraping, providing you with the vast, diverse
                        resources needed for your data gathering needs.</h6>
            ...
            <div class="row mt-5">
                        ...
                        <div class="mt-2">
                            ...
                            <div class="mt-2">
                                <p class="text-explorer">
                                    Enhance reach with 'Location Selection': Customize your proxy network by
                                    selecting
                                    locations with our locations worldwide.
                                </p>
                                <div class="d-flex justify-content-between align-items-center mt-4">
                                    <!-- Text on the left -->

                                    <div>
                                        <a href="{{ url('#') }}">Learn More <i class="fa fa-angle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="card p-3 mb-2">
                        ...
                        <div class="mt-2">
                            <h6 class="heading">Affordable Bandwidth
                            </h6>
                            <div class="mt-2">
                                <p class="text-explorer">
                                    Our affordable IPv6 bandwidth offering represents a significant advancement in
                                    providing cost-effective and efficient internet connectivity.
                                </p>
                                <div class="d-flex justify-content-between align-items-center mt-4 ">
                                    <!-- Text on the left -->
